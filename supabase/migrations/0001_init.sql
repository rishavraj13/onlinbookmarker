...
-- Storage bucket for clipboard attachments (public, unguessable paths: user_id/uuid-filename)
...
create policy "Anyone can view attachments" on storage.objects for select
